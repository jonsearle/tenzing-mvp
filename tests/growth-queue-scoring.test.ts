...
function createInterpretationResult(
  ...
  return {
    ...
    interpretation: {
      ...
      growthVibe: "positive",
      primaryDriver: "Expansion demand is the lead signal.",
      recommendedActionSummary: "Progress the expansion path.",
      confidence: "medium",
      mixedSignals: [],
      createdAt: null,
      updatedAt: null,
      ...
      buildRankingInput(
        ...
        createInterpretationResult("ACC-LOW", {
          interpretation: {
            ...
            relationshipVibe: "neutral",
            growthVibe: "negative",
            primaryDriver: "Commercial upside is weak.",
            recommendedActionSummary: "Do not prioritise expansion yet.",
            confidence: "medium",
            mixedSignals: [],
            createdAt: null,
            updatedAt: null,
