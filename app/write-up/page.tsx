    ...
    <main className="portfolioV2Page writeUpPage">
      <div className="portfolioV2Shell">
        ...
        <section className="portfolioV2Section writeUpSection">
          ...
          <p>
            Right now, the scoring model is still based on assumptions about
            which signals matter most.
          </p>
          <p>
            The most valuable next input is not more proxy signals, but
            historical outcome data.
          </p>
          <p>
            What we need is the record of what actually happened to each
            account, for example:
          </p>
          <ul className="writeUpList">
            <li>Churn</li>
          ...
          <p>
            Those are the lagging outcomes that let us test whether our current
            signals are genuinely predictive.
          </p>
          <p>Today, the model is using leading indicators such as:</p>
          <ul className="writeUpList">
            <li>NPS score</li>
            <li>Sentiment</li>
            <li>SLA breaches</li>
          ...
          <p>
            These are useful warning signs, but we do not yet know which of
            them most strongly correlate with real outcomes.
          </p>
          ...
          <p>
            Without that evidence loop, the current risk model remains
            directionally useful, but it is still an educated guess rather than
